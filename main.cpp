...
int main(int argc, char *argv[])
{
    ...
    //vault class passed by reference, passwords cant be accessed unless vault.verifymaster has correct string passed.
    ...
    //New master if first time accessing application login if database has a master password
